...
public abstract class Mask {
	 ...
	 * @param String mask, EditText editText, the string is used to pass
	 * the format of the mask through a string, for example "##-##-####"
	 * and the EditText that will be watched and changed based in the mask.
	 * */
