...
public class CalendarEventCreator 
{
	...
	/*
	 * Receive a reminder and a context. With those two, create a new entry in google calendar
	 * TODO: correctly input the start time of the event
	 * TODO: We need a better title for the reminder
	 * */
