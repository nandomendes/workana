...
/**
 * Class that is responsible for handling user inputs and 
 * processing the business rules of the system. Nevertheless, 
 * it is important to note that the business rules in this 
 * system are really, really simple. For this reason, a single 
 * controller might be enough. 
 * 
 * @author rbonifacio
 *
 */
public class Controller {
	...
	/* 
	 * Private constructor, according to the 
	...
	/**
	 * The single interface to obtain an instance of 
	 * the Controller class, according to the singleton 
	 * pattern.
	 */
	 ...
	 * @param category the criteria used to filter the reminders.
	 */
	 ...
	 * 
	 * TODO: remove this method after all other public 
