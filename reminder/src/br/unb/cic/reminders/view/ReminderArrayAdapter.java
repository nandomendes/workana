...
public class ReminderArrayAdapter extends ArrayAdapter<Reminder> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView tvReminder = (TextView) reminderRow
				.findViewById(R.id.txtReminder);
	...
	/**
	 * Used to get the DateFirst based in the rowType and proximity to the current date.
	 * @param position
	 * @return
	 */
