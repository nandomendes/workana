...
public class CategoryArrayAdapter extends ArrayAdapter<Category>{
	...
	/**
     * This class is used in the parts of the view which is needed to
     * list the categories, as an adapter to these components listing
     * the Categories items.
     * @param context, and the reminders objects(List<Category>).
     * 
     * @author positivo
     *  
     */
