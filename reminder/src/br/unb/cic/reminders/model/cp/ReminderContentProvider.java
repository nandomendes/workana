...
public class ReminderContentProvider extends ContentProvider {
	...
	@Override
	/**
	 * An external application could not delete an 
	 * existing reminder.
	 */
	...
	@Override
	/**
	 * It is not clear the rationale for this method. Most 
	 * examples just return null.
	 */
	...
	@Override
	/**
	 * Ok, we also do not allow an externa application to update an 
	 * existing reminder. A RuntimeException is thrown.
	 */
