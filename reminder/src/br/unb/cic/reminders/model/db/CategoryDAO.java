...
public interface CategoryDAO {
	 ...
	 * 
	 * @param category - the category that will be stored. 
	 */
	 ...
	 * @param category  the category that will be updated from the database
	 * @throws DBException if anything goes wrong with the database query
	 */
	 ...
	 * @param category  the category that will be dropped from the database
	 * @throws DBException if anything goes wrong with the database query
	 */
