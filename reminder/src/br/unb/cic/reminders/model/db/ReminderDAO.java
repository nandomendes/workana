...
public interface ReminderDAO {
	 ...
	 * 
	 * @param reminder - the reminder that will be stored. 
	...
	/**
	 * List all reminders of the Reminders database, but using 
	 * as criteria a given category
	 * 
	 * @param category the category used as the query criteria 
	 * @return list of registered reminders. 
	 * @throws DBException if anything goes wrong with the database query
	 */
	 ...
	 * @param reminder the reminder that will be updated from the database. it 
	 * contains all fields with the new values and the id of the reminder 
	 * to be updated.  
	 * @throws DBException if anything goes wrong with the database query
	 */
	 ...
	 * @param reminder the reminder that will be dropped from the database
	 * @throws DBException if anything goes wrong with the database query
	 */
	 ...
	 * @param reminder the reminder that will be persisted in the database
	 * @throws DBException if anything goes wrong with the database query
	 */
