...
public class GenericDAO<T> {
	 ...
	 * 
	 * @param entity that will be stored.
	 * 
		...
		try {
			...
			for(Field f : entity.getClass().getDeclaredFields()) {
				if(f.isAnnotationPresent(Column.class)) {
					...
					//in the cases where the field is a related object, mapped by a FK, a specific 
					//behavior is necessary, since we need to get the value of the 
